...
//from a vector of vertexs obtains the min or max coordinates
Vector3 getMaxCoordinates(std::vector<Vector3> vextexs);
Vector3 getMinCoordinates(std::vector<Vector3> vextexs);
